...
myawesomemenu = {
   { "hotkeys", function() hotkeys_popup.show_help((c), awful.screen.focused()) end },
...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.mywibox:setup {
	    ...
	    weather_widget({
		    ...
		    coordinates = {34.932308, -86.571938},
		    time_format_12h = true,
		    units = 'imperial',
		    both_units_widget = true,
		    font_name = 'JetBrainsMono NF ExtraLight',
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey },             "b",	  function() awful.spawn("brave-browser") end,
    	     {description = "Open a browser (brave-browser)", group = "launcher"}),
    -- Brave incognito
    awful.key({ modkey,	"Control"   },             "b",        function() awful.spawn("brave-browser --incognito") end,
             {description = "Open a browser (brave-browser --incognito)", group = "launcher"}),
    -- firefox
    awful.key({ modkey },             "i",        function() awful.spawn("firefox") end,
             {description = "Open a browser (firefox)", group = "launcher"}),
    -- Firefox incognito	    
    awful.key({ modkey, "Control"   },             "i",        function() awful.spawn("firefox --private") end,
             {description = "Open a browser (firefox --private)", group = "launcher"}),
